...
[TestFixture]
public class GetTeamValidatorTests
{
    private GetTeamValidator _validator;
    ...
    public void SetUp()
    {
        ...
        _validator = new GetTeamValidator(_teamRepository.Object);
    }
    
    [Test]
    public async Task Should_Have_Error_When_Id_Is_Empty()
    {
        var model = new GetTeamQuery() { Id = Guid.Empty };
    ...
    {
        var model = new GetTeamQuery { Id = Guid.NewGuid() };
